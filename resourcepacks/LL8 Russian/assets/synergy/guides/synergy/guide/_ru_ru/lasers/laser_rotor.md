...
Производит FE при питании от той же лазерной машины со всех сторон
...
### Example of setup to generate manually FE using a Лазерный ротор
...
<BoxAnnotation color="#0095ff" min="7.25 0 5.25" max="7.75 0.5 5.75">
       When rotated it will change the path touching another side of the Лазерный ротор
  </BoxAnnotation>
