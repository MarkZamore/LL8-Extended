...
| Assorted ready Russian (LL8 gap subset) | Slava_vas (MPLOCmods v40.1); RushanM; The Cobblemon Team (Cobblemon 1.8.0); Refined Mods (Refined Storage 2); G0ludo (Horrors Russified); KlimeGM (RTC 4.0); xaxilin (ERP) | у каждого файла своя: CC BY-NC-SA 4.0; MIT; MPL-2.0; MIT; CC BY-SA 4.0; MIT; Apache-2.0 | см. `LL8-MODIFICATION.txt` внутри |
...
проверен на лицензию, версию и качество. Кроме уже названных, взяты 24 строки
из семи мелких источников (выжимка «Assorted ready Russian»). Не взяты
